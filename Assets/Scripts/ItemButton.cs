...
public class ItemButton : MonoBehaviour
{
    ...
    public void Press()
    {
        ...
        if (Shop.instance.ShopMenu.activeInHierarchy)
        {
            ...
            {
                Shop.instance.selectedBuyItem(GameManager.instance.GetItemDetails(Shop.instance.itemsForSale[buttonValue]));
            }

            if (Shop.instance.SellMenu.activeInHierarchy)
            {
                Shop.instance.selectedSellItem(GameManager.instance.GetItemDetails(GameManager.instance.itemsHeld[buttonValue]));
            }
        }
